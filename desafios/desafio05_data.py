...
class Historico:
    ...
    #     return self._transacoes_diarias
    ...
    def transacoes_do_dia(self):
        ...
        hoje = '%d-%m-%Y %H:%M'
        hoje = datetime.now().strftime(hoje)
        transacoes_diarias = [transacao for transacao in self.transacoes if transacao['data'][:-6] == hoje[:-6]]

        # transacoes_diarias = []
        # for transacao in self.transacoes:
        #     if transacao['data'][:-6] == hoje[:-6]:
