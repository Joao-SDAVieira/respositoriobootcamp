...
def log_transacao(func):
    def operacao(*args,**kwargs):
        ...
        print(f"Função: {func_name.capitalize()}, Hora: {datetime.now()}")
        return resultado
    return operacao
...
def exibir_extrato(clientes):
    ...
    inserted_transacao = input('Selecione o tipo de transação.\n[S]aque ou [D]eposito: ou Enter para visualizar tudo')
    print("\n================ EXTRATO ================")
    # TODO: atualizar a implementação para utilizar o gerador definido em Historico
    
    for i in conta.historico.gerar_relatorio(inserted_transacao.upper()):
        print(i)
    # transacoes = conta.historico.transacoes
    # print(f'transacoesaquii {transacoes}')
    # extrato = ""
    # if not transacoes:
