    ...
    def envelope(*args, **kwargs):
        ...
        try:
            ...
            # TODO: alterar a implementação para salvar em arquivo.
                valor_arquivo = f"[{data_hora}] Função '{func.__name__}' executada com argumentos {args} e {kwargs}. Retornou {resultado}\n"
                log.write(valor_arquivo)
        except FileNotFoundError as exc:
            print('Arquivo não existente',exc)
